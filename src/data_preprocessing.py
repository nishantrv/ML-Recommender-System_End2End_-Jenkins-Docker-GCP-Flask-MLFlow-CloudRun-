...
class DataProcessor:
    ...
    def select_features(self,df):
        try:
            ...
            raise CustomException('Error while feature selection step', e)
    ...
    def process(self):
        try:
            ...
            logger.error(f'Error data preprocessing pipeline {e}')
            raise CustomException('Error data preprocessing pipeline', e)
